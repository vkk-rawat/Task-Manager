...
export const ProjectCard = ({ project, canManage, onEdit, onDelete }) => (
  <article className="glass-panel rounded-[24px] p-5 transition duration-200 hover:-translate-y-0.5">
    <div className="flex items-start justify-between gap-3">
      <div className="min-w-0">
        <Link
          to={`/projects/${project._id}`}
          className="text-lg font-semibold text-slate-950 hover:text-slate-700 dark:text-white dark:hover:text-slate-300"
        >
          {project.title}
        </Link>
