...
export const STATUS_META = {
  ...
  "In Progress": {
    label: "In Progress",
    className:
      "bg-sky-100 text-sky-700 border-sky-200 dark:bg-sky-950 dark:text-sky-200 dark:border-sky-800",
  },
  Done: {
    label: "Done",
    className:
...
export const PRIORITY_META = {
  Low: {
    label: "Low",
    className:
      "bg-teal-50 text-teal-700 border-teal-200 dark:bg-teal-950 dark:text-teal-200 dark:border-teal-800",
  },
  Medium: {
    label: "Medium",
    className:
